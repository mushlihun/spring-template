...
public class ProductRequestDTO {
    ...
    public ProductRequestDTO(String name, String description, String productType, int quantity, double price, String supplierName, String supplierCode) {
    	this.name = name;
